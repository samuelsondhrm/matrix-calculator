...
public class Matrix {
    ...
    public Matrix augment(Matrix B) {
        if (B == null || this.rows != B.rows) {
            throw new IllegalArgumentException("Augment: jumlah baris harus sama dan B tidak boleh null.");
        }
