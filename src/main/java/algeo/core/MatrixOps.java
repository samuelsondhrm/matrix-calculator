...
public final class MatrixOps {
     ...
     * - Track pertukaran baris (ubah tanda)
     * - Track skala baris (jarang diperlukan jika hanya eliminasi r <- r - k*rowPivot)
     * - Hasil = produk diagonal atas setelah REF dikali faktor tanda.
     *
     * Catatan:
     * - Tidak stabil untuk matriks singular ~epsilon; gunakan eps untuk deteksi nol.
